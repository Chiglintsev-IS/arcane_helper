...
/**
 * Блок отыгрыша: одна реплика цельной фразой (FR-050), три категории (FR-051) и управление
 * вариантами (FR-053).
 *
 ...
 * одной правды.
 *
 * Первый тест сторожит склейку: до этой работы карточка показывала «Стой на месте. · Холодно.» —
...
import type { AppStores } from "@/store/provider";
 ...
 * (FR-050 требует три на заклинание), а порядок и ротацию видно только на нескольких.
 */
