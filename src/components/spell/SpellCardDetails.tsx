/**
 * Подробная карточка заклинания (FR-011, FR-012).
 *
 ...
 * (ux.md#общие-правила), а художественный текст живёт в отдельном блоке с другим оформлением: смешивать
 * его с механикой запрещено (AC-20, ADR-0005).
 *
...
import { CANTRIP_LEVEL, type CastMode } from "@/rules/slots";
