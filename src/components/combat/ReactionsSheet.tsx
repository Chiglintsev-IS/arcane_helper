/**
 * Экран реакций (FR-060, FR-061, FR-062).
 *
 ...
 * 17 ([FR-062](../../../docs/features/F-05-reactions.md#fr-062)). Складывать базу, Ловкость, предметы
...
import { armorClassWithSpell, effectiveArmorClass } from "@/rules/armorClass";
import {
  availableTriggers,
  reactionsFor,
...
export function ReactionsSheet({
  ...
  /** Есть ли чем ответить на провал спасброска: руна и нерастраченная реакция (FR-153). */
  ...
  return (
    ...
    >
      ...
      {/*
        ...
        может попросить исключение у мастера (FR-031). Причина написана словами.
      */}
