...
export function CombatScreen() {
  ...
  // [FR-162](../../docs/features/F-14-campaign-restrictions.md#fr-162) отменено,
  ...
  // Ход начинается только в бою (FR-202), «Реакции» стоят в бою и вне боя (FR-153, FR-220). Оба
      ...
      <div className="flex shrink-0 flex-col gap-2 border-b border-slate-200 p-3 dark:border-slate-800">
        ...
        */}
        ...
        {/*
          ...
          (FR-220), а пустая обёртка всё равно забрала бы промежуток родителя — 8 пикселей, которых
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 pb-3 pt-2">
        ...
        */}
        ...
        {/*
          ...
          же причине (FR-220): там разбирают случившееся, а не выбирают, чем ответить. Без этой
