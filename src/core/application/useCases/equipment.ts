 ...
 * потому обе правки одинаково попадают в лог и отменяются.
 *
 ...
 * её запас: лог называет получившееся количество, потому что «Добавлено: зелье лечения» дважды
...
/**
 * Меняет запас вещи в сумке: минус — расход, плюс — пополнение. Лог называет получившееся число,
...
/** Правка кошелька. Лог называет только сдвинувшиеся монеты: «зм 15 → 215». */
