 ...
 * сколько её лежит.
 *
 * Расход всех видов идёт одной записью лога: изготовление из трёх видов, записанное тремя
 ...
 * тратит: так велит справочник, и запись о нём стоит в логе рядом с удачей.
 */
 ...
 *
 * Через лог, как всякая правка листа: купленный модуль и выученное направление двигают пределы
 ...
 *
 * Через лог, как всякая правка знания: с отметки счёт раскрытого называется со знаменателем, и
