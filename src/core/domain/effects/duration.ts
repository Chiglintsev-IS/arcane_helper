 ...
 *
 * Отмеряемое временем отдых закрывает, потому что столько времени он и занимает; отмеряемое рукой
 * игрока — тоже: ночь длиннее почти всего, что отмечают посреди схватки. Отмеряемое самим
 * заклинанием он не кончает: за время сна магия сама не рассеивается, вызванная сущность сама не
 * исчезает.
 */
