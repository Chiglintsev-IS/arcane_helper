...
/**
 * Отвергает запись запаса или кошелёк, которые не проходят своих объявлений, — с причиной словами.
 *
 * Спрашивает те же схемы, которыми проверяется сохранённое состояние: числа запаса и монеты
