...
import { BANNED_SPELLS, loadThorneSpells, HARMFUL_DAMAGE_TYPES } from "@/core/infrastructure/catalog/thorne";

import { matchesQuery } from "@/core/domain/spellbook/restrictions";
...
// matchesQuery служит поиску по книге и строке «Магия крови», а не запретам кампании:
// findBan, отвечавший на поиск запрещённого, удалён вместе с требованием.
