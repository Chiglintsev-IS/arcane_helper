 ...
 *
 * Числа поиска, сбора и выхода стоят полями справки вида, а словами рядом остаётся то, чего поле
 * не выражает: где искать, чем вид особенный и что стол о нём сказал сверх перечня.
 */
type Revealed = { number: number; nameRu: string; dirRu?: string };
...
const INGREDIENTS: readonly {
...
}[] = [
  {
    ...
    gold: 85,
    revealed: [
      { number: 1, nameRu: "Снижение потребности в пище и воде", dirRu: BREWING },
      { number: 2, nameRu: "Усиление характеристики (Выносливость)", dirRu: BREWING },
    ],
    findDc: 8,
    gatherDc: 8,
    yieldRu: "порция с каждых 250 г куска",
    portionRu: "250 г свежей мякоти вместе с соком",
    notes: ["Плод великаньей яблони: искать у плодоносящей гальперы, сок быстро окисляется"],
  },
  {
    ...
    gold: 15,
    revealed: [
      { number: 1, nameRu: "Ускорение роста растений", dirRu: BREWING },
      { number: 2, nameRu: "Усиление характеристики (Сила)", dirRu: BREWING },
    ],
    findDc: 10,
    gatherDc: 12,
    yieldRu: "4к20 + 40 порций с шара около 30 сантиметров",
    portionRu: "20 г очищенной сухой пыльцы",
    notes: [
      "Искать на цветущей гальпере: ошибка сбора рассеивает облако пыльцы",
      "Оптовая партия обычно дешевле",
    ],
  },
  {
    ...
    gold: 15,
    revealed: [
      { number: 1, nameRu: "Отвращение к пиву", dirRu: POISONS },
      { number: 2, nameRu: "Ослабление характеристики (Выносливость)", dirRu: POISONS },
    ],
    findDc: 12,
    gatherDc: 13,
  ...
  },
  {
    ...
    gold: 5,
    revealed: [
      { number: 1, nameRu: "Лечение здоровья", dirRu: BREWING },
      { number: 2, nameRu: "Остановка кровотечения", dirRu: BREWING },
      { number: 3, nameRu: "Сопротивление типу урона (ядовитый)", dirRu: BREWING },
    ],
    findDc: 9,
    gatherDc: 7,
    yieldRu: "1к6 + 1 порций с заросли",
    portionRu: "пучок 8–10 листьев, около 40 г",
    notes: [
      "Искать на влажных обочинах, лугах и по краям болот",
  ...
  },
  {
    ...
    count: 16,
    gold: 1,
    revealed: [{ number: 1, nameRu: "Противоядие", dirRu: BREWING }],
    findDc: 8,
    gatherDc: 7,
    yieldRu: "1к4 + 2 порции с грибницы",
    portionRu: "3 средних плодовых тела: около 60 г свежих или 15 г сухих",
    notes: [
      "2-е свойство — направление «Синтез ядов»: реакция обнаружена, но без навыка и профильного модуля точный эффект не раскрыть",
      "Искать на сырых кочках и у гниющих пней",
    ],
  },
  {
    nameRu: "«Неожиданность Зинаиды»",
    count: 3,
    revealed: [{ number: 1, nameRu: "Диарея", dirRu: POISONS }],
    findDc: 17,
    gatherDc: 15,
    yieldRu: "1к4 + 1 порций с колонии",
    portionRu: "зрелое плодовое тело, 50–70 г",
    notes: [
      "Расчётная ценность 1 350 золотых: устойчивого рынка почти нет",
      "Сырая мякоть вызывает рвоту: это проявление сырого образца, свойств оно не раскрывает",
      "Искать во влажных местах со следами старой магии",
    ],
  },
  {
    ...
    count: 2,
    revealed: [
      { number: 1, nameRu: "Омоложение", dirRu: BREWING },
      { number: 2, nameRu: "Регенерация здоровья", dirRu: BREWING },
    ],
    findDc: 10,
    gatherDc: 14,
    yieldRu: "1к6 + 2 порции за безопасный сбор",
    portionRu: "10 зрелых листьев, около 25 г",
    notes: [
      "Расчётная ценность 3 300 золотых: устойчивого рынка почти нет",
      "Найти можно, только если дерево уже найдено; повторный сбор требует восстановления кроны",
    ],
  },
  {
    ...
    count: 2,
    revealed: [
      { number: 1, nameRu: "Постоянное усиление случайной характеристики", dirRu: BREWING },
      { number: 2, nameRu: "Полное восстановление здоровья", dirRu: BREWING },
    ],
    findDc: 15,
    gatherDc: 16,
  ...
  },
  {
    ...
    gold: 90,
    revealed: [
      { number: 1, nameRu: "Галлюцинации", dirRu: POISONS },
      { number: 2, nameRu: "Уменьшение существа", dirRu: BREWING },
    ],
    findDc: 14,
    gatherDc: 11,
    yieldRu: "1к6 порций с грибницы",
    portionRu: "зрелое плодовое тело, 25–35 г",
    notes: ["Искать в сырых корневых пустотах и тёмных участках старого болота"],
  },
  {
    nameRu: "Лунная роза",
    count: 0,
...
const RAW: unknown = {
  ...
  itemDefinitions: [
    ...
    ...INGREDIENTS.map(({ nameRu, gold, revealed, notes, solo, ...reference }) => ({
      ...
      alchemy: {
        properties: revealed ?? [],
        ...(reference.findDc === undefined ? {} : { findDc: reference.findDc }),
