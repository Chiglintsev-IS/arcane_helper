 ...
 * docs/rules-engine.md#класс-доспеха, выбор места хранения вклада — ADR-0013.
 *
...
import type { ArmorClassEffect, Spell } from "@/data/schemas/spell";
 ...
 * когда эффекта ещё нет и состояние менять нельзя (FR-022).
 *
