 ...
 *
 * Расход попадает в журнал и отменяется оттуда, как любая другая правка запаса.
 */
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-ink-quiet">
        Повод и бросок ведёт стол: приложение считает только запас. Расход попадает в журнал и
        отменяется оттуда.
      </p>
