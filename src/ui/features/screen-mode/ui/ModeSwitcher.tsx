 ...
 * среди фильтров. Кнопки, а не выпадающий список: за столом смотрят одним взглядом и попадают
 * одним пальцем.
 *
 * Компонент презентационный: режим приходит параметром, смена — обратным вызовом.
 *
 * Кнопок четыре, и ряд прокручивается по горизонтали: равная ширина на четверых сжала бы
 ...
 *
 * Средний режим называется «Вне боя», а не «Привал»: вне боя бывает город, дорога и
