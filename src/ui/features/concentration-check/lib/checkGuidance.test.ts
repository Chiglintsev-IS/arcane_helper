/**
 * Подпись к проверке концентрации.
 *
 * Вердикт приходит перечислением, и здесь проверяется только выбор фразы под него. Из каких чисел
 * вердикт следует — дело правила и его прогона.
 */
