 ...
 *
 * Рисунок приезжает начерченным: слои идут в порядке рисования, фигуры — в единицах листа. Здесь
 * остаётся перо — цвет, толщина, пунктир и то, чем фигура называется в разметке.
 *
 * Заливок нет и цвет наследуется от текста: схема живёт в обеих темах и повторяется рукой.
 ...
 * Одна фигура рисунка.
 *
 * `vectorEffect` стоит на каждой фигуре: без него толщина линии зависит от того, во что растянут
 * лист, — на телефоне схема выходила волосяной, а на планшете жирной.
 */
