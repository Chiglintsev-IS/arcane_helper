/**
 * Экран журнала — единственное место, где отменяют.
 *
 * Список плоский и свежее сверху: отменяемая запись всегда первая и не требует прокрутки. Кнопка
 * стоит только на ней — отменяется лишь последнее действие, а кнопка на остальных записях
 ...
 * трогает, как и остальные компоненты экрана.
 */
 ...
 * второй строкой на iPhone SE платят ровно ничем не оправданной подробностью.
 */
