 ...
 *. Объявление, отыгрыш и подтверждение
 * живут на одном экране раздельными блоками.
 *
 * Инвариант держится структурой: этот компонент меняет только черновик. Единственное действие,
