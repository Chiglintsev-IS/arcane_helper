 ...
 *
 * Существует ради «Магии крови»: она стоит в том же списке и обязана отзываться на те же
 * переключатели. Пока фильтры принимали только заклинание, строка молча
...
/** Строка «Магия крови»: обмен хитов на очки хода не занимает и ячеек не тратит. */
