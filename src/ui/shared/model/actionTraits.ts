 ...
 *
 * Существует ради строк, заклинанием не являющихся: они стоят в том же списке и обязаны
 * отзываться на те же переключатели. Пока фильтры принимали только заклинание, такая строка молча
