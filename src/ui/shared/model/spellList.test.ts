...
import { SCREEN_MODES } from "@/core/shared/screenMode";
import { belongsToMode, castableWithinTurn, combatOrderKey, compareCombatTraits, orderForCombat, preparedForCombat, spellsForMode, spellsForScreen } from "@/ui/shared/model/spellList";
...
describe("отбор по режиму (FR-201, FR-202, FR-203)", () => {
  ...
  it("ритуал действием остаётся в бою и в книге: способы разные, заклинание одно", () => {
    // «Обнаружение магии» в бою идёт за ячейку, в книге — ритуалом за лишние 10 минут.
...
describe("боевой список: состав и порядок (FR-209, FR-210)", () => {
  it("содержит заговоры и подготовленные, но не остальное", () => {
    ...
    // Заговоры входят вне лимита подготовки; ритуалы в стартовый набор не входят.
