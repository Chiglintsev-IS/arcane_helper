 ...
 *
 * Это встроенный каталог: он действует, пока игрок не загрузил свой файл (FR-123). Каталог здесь не
 ...
 *
 * В хранилище эти карточки не попадают ([ADR-0019](../../../../docs/decisions.md#adr-0019)): их
