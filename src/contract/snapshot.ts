 ...
 * записи лога, а не поля, из которых их надо выводить. Экран, чья проекция ещё не написана,
...
/**
 * Запись лога так, как её показывают: время, подпись и то, к чему запись относится.
 *
 ...
 *
 * Рядом с записью лога, а не среди проекций: у обеих наружу едет сама запись, а не посчитанное
...
export const snapshotSchema = z.object({
   ...
   *
   * Идентификаторами, а не строками: те же строки уже приехали списком, и вторая их копия
   * разошлась бы с первой в тот же миг, когда изменится цена или причина отказа.
   */
  /**
