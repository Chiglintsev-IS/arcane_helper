  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/ui/**/model/**",
        // Правила отображения: подпись, разбор и свод — поведение, а не разметка. Шаблон, а не
        // перечень каталогов: названный поимённо отстаёт от следующего такого же молча.
        "src/ui/**/lib/**",
      ],
      exclude: [
