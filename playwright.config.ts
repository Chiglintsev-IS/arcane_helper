...
/**
 * E2E-прогоны в мобильных viewport.
 *
 * iPhone SE обязателен: на нём проверяется требование «ключевая механика без прокрутки».
 * Остальные размеры добавляются по мере надобности — тратить время прогона на три одинаковых
 * сценария смысла нет, пока вёрстка одна.
 *
