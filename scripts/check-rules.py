...
#
# Названия алхимических свойств: перечень справочника — их владелец, а начальное содержимое
# персонажа называет те из них, которые стол уже раскрыл. Копия здесь не расходится молча: схема
# состояния сверяет каждое название с перечнем и отвергает то, которого в нём нет.
