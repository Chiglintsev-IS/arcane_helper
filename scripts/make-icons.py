#!/usr/bin/env python3
"""Иконки приложения для установки на домашний экран (F-12, AC-01).

Рисуются кодом, а не растром из редактора: иконка — та же схема ритуала, что
приложение рисует внутри ([ADR-0014](../docs/decisions.md#adr-0014)), и повторить
...
# Цвета из cветовой системы: фон — тёмная тема, знак — цвет ритуала (docs/ux.md).
BACKGROUND = (11, 17, 32)
INK = (96, 191, 138)
