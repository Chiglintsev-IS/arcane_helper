...
- Спека — источник истины: поведение меняется вместе с документом в том же наборе правок. Спека этой работы — `.superpowers/specs/2026-08-02-resolution-label-consistency-design.md`.
